...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(135deg, #0a0014 0%, #1a0030 40%, #12001c 70%, #09090f 100%)',
        minHeight: 420,
      }}
    >
      {/* BG decoration */}
      ...
      <div
        className="relative px-4 lg:px-8 py-16 flex flex-col items-center text-center"
      ...
      >
        ...
        {/* Search box */}
        <div
          className="mt-8 w-full max-w-2xl flex flex-col sm:flex-row gap-3 p-3 rounded-2xl"
          style={{
